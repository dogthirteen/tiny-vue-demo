...
tinymce.PluginManager.add('axupimgs', function (editor, url) {
	let pluginName = '多图上传';
	let axupimgs = {}; //扔外部公共变量，也可以扔一个自定义的位置
	// let baseURL = tinymce.baseURL;
	// let iframe1 = baseURL + '/plugins/axupimgs/upfiles.html';
	let iframe1 = '/tinymce/plugins/axupimgs/upfiles.html';
